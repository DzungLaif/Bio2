# -*- coding: utf-8 -*-
from Solution1_Representing_and_Searching_Probabilistic_Motifs import MyMotifs
from Solution1_Representing_and_Searching_Probabilistic_Motifs import MySeq
